...
public class DAO_Tau {
	...
	/** Lấy tên tàu từ mã tàu */
	public static String getTenTauByMaTau(String maTau) throws SQLException {
		String sql = "SELECT tenTau FROM ChuyenTau WHERE maTau = ?";
		...
		return maTau; // fallback nếu không tìm thấy
	}
